<%-- 
    Document   : listaRelatorioCliente
...
<html>
    ...
    <body>
        <h1>RELATÓRIO DE CLIENTES | DETALHE</h1></br>
    <center><div>
  ...
  <path fill-rule="evenodd" d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"/>
        ...
        <table id="tblData" class="table" width=1900 height=200>
            ...
            <tbody>
            <c:forEach var="venda" items="${listaClientesRelatorio}">
                    <tr>
